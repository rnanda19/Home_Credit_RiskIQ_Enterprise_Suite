...
- Sample reports (fixture-generated, same 3-format convention as Mega Project 1): [`sample_reports/`](sample_reports/)
...
headless recalculation. **Not yet run against real data.**
...
closed-form capital number (1.35% relative difference on this suite's
fixture, well within the documented 10% tolerance) and a real
...
per-applicant loop, no PD re-scoring). Verified end-to-end on this suite's
synthetic fixture: 0 execution errors, all pipeline integrity and scenario
validation checks pass, HTML dashboard confirmed under a network-blocked
Playwright check, Excel workbook confirmed via LibreOffice headless
recalculation. **Not yet run against real data.**
...
[1.4.7]. Verified end-to-end on this suite's synthetic fixture: 0
...
dimensions. Verified end-to-end on this suite's synthetic fixture: 0
